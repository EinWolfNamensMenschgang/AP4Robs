...
void Subscriber::subscribe(const char* serverIP, int port, int messageSize, std::vector<char>& returnString){ //SERVERPORT, message size is expected number of chars in one Message
